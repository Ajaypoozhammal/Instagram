...
import '../Block/HighilightBloc/highlight_bloc.dart';
import '../Block/MainBlock/instagram_bloc.dart';
import '../Block/PostBloc/post_bloc.dart';
import '../Block/TagBloc/tag_bloc.dart';
import '../Repository/ModelClass/HighlightModel.dart';
import '../Repository/ModelClass/InstagramModel.dart';
import '../Repository/ModelClass/PostModel.dart';
import '../Repository/ModelClass/TagModel.dart';
import '../Screen2.dart';
import '../Screen3.dart';
...
class _Screen4State extends State<Screen4> {
  ...
  void initState() {
    ...
    BlocProvider.of<InstagramBloc>(context).add(FetchInstagram(name: widget.Name));
    BlocProvider.of<HighlightBloc>(context).add(FetchHighlight(name: widget.Name));
